...
namespace org.bidib.netbidibc.core.Models.BiDiB
{
    ...
    public class Node : ModelBase
    {
        ...
        /// <summary>
        /// Indicates if node contains guest functionalities
        /// </summary>
        [XmlIgnore]
        ...
        private void UpdateNodeInfo()
        {
            ...
            BitArray pidBits = new BitArray(new[] { UniqueIdBytes[3], UniqueIdBytes[4], UniqueIdBytes[5], UniqueIdBytes[6] });

            int newPid = 0;

            for (int i = 0; i < NumberOfProductIdBits; i++)
            {
                if (pidBits[i])
                {
