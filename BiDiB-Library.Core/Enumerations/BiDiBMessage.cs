...
namespace org.bidib.netbidibc.core
{
    public enum BiDiBMessage : byte
    {
        ...
        MSG_GATE_REQ_SUBSCRIBE = 81,
        MSG_GATE_REQ_SEND = 82,
        MSG_GATE_REQ_TAKE_RESPONSIBILITY = 83,
        MSG_GATE_REQ_PASS_RESPONSIBILITY = 84,

        MSG_GUEST_RESP_SUBSCRIPTION = 88,
        MSG_GUEST_RESP_SENT = 89,
        MSG_GUEST_RESP_NOTIFY = 90,
        MSG_GUEST_RESP_RESPONSIBILITY = 91,
        ...
        MSG_LOCAL_ACCESSORY = 115,  //*// 1:statusflag, 2,3: DCC-accessory addr
        ...
        MSG_GUEST_REQ_SEND = 209,
        MSG_GUEST_REQ_TAKE_RESPONSIBILITY = 210,
        MSG_GUEST_REQ_PASS_RESPONSIBILITY = 211,

        MSG_GATE_RESP_SUBSCRIPTION = 216,
        MSG_GATE_RESP_SENT = 217,
        MSG_GATE_RESP_NOTIFY = 218,
        MSG_GATE_RESP_RESPONSIBILITY = 219,
