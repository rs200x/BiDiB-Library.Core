...
namespace org.bidib.netbidibc.core.Test.Message
{
    ...
    public class MessageFactoryTests : TestClass
    {
        [TestMethod]
        public void CreateInputMessage_ShouldReturnSysErrorMessage()
        {
            ...
            // Act
            SysErrorMessage message = MessageFactory.CreateInputMessage(bytes) as SysErrorMessage;
        ...
        public void CreateInputMessage_ShouldReturnSysUniqueIdMessage()
        {
            ...
            // Act
            SysUniqueIdMessage message = MessageFactory.CreateInputMessage(bytes) as SysUniqueIdMessage;
        ...
        public void CreateInputMessage_ShouldReturnCommandStationProgStateMessage()
        {
            ...
            // Act
            CommandStationProgStateMessage message = MessageFactory.CreateInputMessage(bytes) as CommandStationProgStateMessage;
        ...
        public void CreateInputMessage_ShouldReturnCommandStationStateMessage()
        {
            ...
            // Act
            CommandStationStateMessage message = MessageFactory.CreateInputMessage(bytes) as CommandStationStateMessage;
        ...
        public void CreateInputMessage_ShouldReturnCommandStationPoMAckMessage()
        {
            ...
            // Act
            CommandStationPoMAckMessage message = MessageFactory.CreateInputMessage(bytes) as CommandStationPoMAckMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackCvMessage()
        {
            ...
            // Act
            FeedbackCvMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackCvMessage;
        ...
        public void CreateInputMessage_ShouldReturnBoosterDiagnosticMessage()
        {
            ...
            // Act
            BoostDiagnosticMessage message = MessageFactory.CreateInputMessage(bytes) as BoostDiagnosticMessage;
        ...
        public void CreateInputMessage_ShouldReturnNodeNewMessage()
        {
            ...
            // Act
            NodeNewMessage message = MessageFactory.CreateInputMessage(bytes) as NodeNewMessage;
        ...
        public void CreateInputMessage_ShouldReturnNodeLostMessage()
        {
            ...
            // Act
            NodeLostMessage message = MessageFactory.CreateInputMessage(bytes) as NodeLostMessage;
        ...
        public void CreateInputMessage_ShouldReturnNodeTabMessage()
        {
            ...
            // Act
            NodeTabMessage message = MessageFactory.CreateInputMessage(bytes) as NodeTabMessage;
        ...
        public void CreateInputMessage_ShouldReturnNodeTabCountMessage()
        {
            ...
            // Act
            NodeTabCountMessage message = MessageFactory.CreateInputMessage(bytes) as NodeTabCountMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackAddressMessage()
        {
            ...
            // Act
            FeedbackAddressMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackAddressMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackDynStateMessage()
        {
            ...
            // Act
            FeedbackDynStateMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackDynStateMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackMessage()
        {
            ...
            // Act
            FeedbackMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackOccupiedMessage()
        {
            ...
            // Act
            FeedbackOccupiedMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackOccupiedMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackMultipleMessage()
        {
            ...
            // Act
            FeedbackMultipleMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackMultipleMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackSpeedMessage_WithForwardDirection()
        {
            ...
            // Act
            FeedbackSpeedMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackSpeedMessage;
        ...
        public void CreateInputMessage_ShouldReturnFeedbackPositionMessage()
        {
            ...
            // Act
            FeedbackPositionMessage message = MessageFactory.CreateInputMessage(bytes) as FeedbackPositionMessage;
        ...
        public void CreateInputMessage_ShouldReturnSysMagicMessage()
        {
            ...
            // Act
            SysMagicMessage message = MessageFactory.CreateInputMessage(bytes) as SysMagicMessage;
        ...
        public void CreateInputMessage_ShouldReturnVendorAckMessage()
        {
            ...
            // Act
            VendorAckMessage message = MessageFactory.CreateInputMessage(bytes) as VendorAckMessage;
        ...
        public void CreateInputMessage_ShouldReturnVendorMessage()
        {
            ...
            // Act
            VendorMessage message = MessageFactory.CreateInputMessage(bytes) as VendorMessage;
        ...
        public void CreateInputMessage_ShouldReturnNull_WhenInvalidMessage()
        {
            ...
            // Act
            var message = MessageFactory.CreateInputMessage(bytes);
        ...
        public void CreateInputMessage_ShouldReturnAccessoryParaMessage_NotExistingParam()
        {
            ...
            // Act
            AccessoryParaMessage message = MessageFactory.CreateInputMessage(bytes) as AccessoryParaMessage;
        ...
        {
            // Arrange
            byte[] bytes = GetBytes("0D-01-00-1D-B8-00-03-14-01-DB-01-69-02-14-05-01-00-1E-A1-04-30-FE");

            // Act
            AccessoryStateMessage message = MessageFactory.CreateInputMessage(bytes) as AccessoryStateMessage;
            ...
            message.Options.Should().ContainInOrder(new byte[] { 1, 105, 2, 20 });
        }
        ...
        public void CreateInputMessage_ShouldReturnAccessoryStateMessageWithError()
        {
            ...
            message.Options.Should().HaveCount(4);
            message.Options.Should().ContainInOrder(new byte[] { 1, 0, 2, 0 });
        }
        ...
        public void CreateInputMessage_ShouldReturnLcConfigXMessage()
        {
            ...
            // Act
            LcConfigXMessage message = MessageFactory.CreateInputMessage(bytes) as LcConfigXMessage;
        ...
        public void CreateInputMessage_ShouldReturnLStatMessage()
        {
            ...
            // Act
            LcStatMessage message = MessageFactory.CreateInputMessage(bytes) as LcStatMessage;
        ...
        public void CreateInputMessage_ShouldReturnBoostStatMessage_WithBusControl()
        {
            ...
            // Act
            BoostStatMessage message = MessageFactory.CreateInputMessage(bytes) as BoostStatMessage;
